<template>
  ...
  >
    ...
    <span style="--index: 2;">  <Icon class="!text-9xl opacity-60" icon="material-symbols:sad-tab-outline-rounded"/></span> -->
        <span class="!text-9xl font-jersey -mt-[2px] opacity-60" style="--index: 0">
          <span>404</span>
        </span>
        <span class="!text-9xl font-jersey opacity-60" style="--index: 1">
          <span>404</span>
        </span>
        <span class="!text-9xl font-jersey mt-[2.7px] opacity-60" style="--index: 2">
          <span>404</span>
        </span>
      </div>
    </div>
    <div class="text-lg font-bold tracking-widest uppercase opacity-60">
      look like you're lost
    </div>
    <div
      class="flex justify-center w-40 p-1 tracking-widest uppercase transition-all duration-200 cursor-pointer bg-cyan-500 hover:w-96"
      @click="redirect"
    >
      let's head back
    </div>
