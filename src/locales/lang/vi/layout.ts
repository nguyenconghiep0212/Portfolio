export default {
  ...
  setting: {
    ...
    menuTriggerTop: 'Top',
    // menu type
    menuTypeSidebar: 'Chế độ Left',
    menuTypeMixSidebar: 'Chế độ Left Kết hợp',
    menuTypeMix: 'Chế độ kết hợp Top và Left',
    menuTypeTopMenu: 'Top menu mode',

    //Theme mode
    themeModeModern: 'Giao diện hiện đại',
    themeModeRobotic: 'Giao diện kiểu robotic',
    ...
    navMode: 'Mẫu thanh điều hướng',
    interfaceFunction: 'Chức năng',
    interfaceDisplay: 'Hiển thị',
    animation: 'Hiệu ứng',
    splitMenu: 'Split menu',
    closeMixSidebarOnChange: 'Switch page to close menu',

    sysTheme: 'Màu chủ đạo',
    headerTheme: 'Màu Thanh Header',
    sidebarTheme: 'Màu Menu',
